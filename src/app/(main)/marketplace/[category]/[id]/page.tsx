...
// THE FIX: The unused 'User' icon has been removed. 'ShieldCheck' has been added.
...
import Image from 'next/image'; // Import Image for the author avatar
...
export default async function MarketplaceDetailPage({ params }: { params: { id: string } }) {
  ...
  const listing = await prisma.listing.findUnique({
    where: { id: params.id },
    include: {
      // We now fetch `emailVerified` for the "Verified Seller" badge
